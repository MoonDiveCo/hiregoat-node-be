class ApiResponse {
	...
	static success(res, msg) {
		return new ApiResponse(res, msg, 200);
	}

	static unauthorized(res, msg) {
		return new ApiResponse(res, msg, 401)
	}

	static badRequest(res, msg) {
		return new ApiResponse(res, msg, 400)
	}

	static internal(res, msg) {
		return new ApiResponse(res, msg, 500);
	}

	static notFound(res, msg) {
		return new ApiResponse(res, msg, 404)
	}

	static conflict(res, msg) {
		return new ApiResponse(res, msg, 409)
	}

	static forbidden(res, msg) {
		return new ApiResponse(res, msg, 403)
	}

	static invalid(res, msg) {
		return new ApiResponse(res, msg, 402)
	}
